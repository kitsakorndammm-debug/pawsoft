  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        'data-active:bg-primary/10 data-active:font-medium data-active:text-primary! dark:data-active:border-transparent dark:data-active:bg-primary/15 dark:data-active:text-primary!',
