...
/**
 * มุมมองสัปดาห์ — จันทร์ถึงอาทิตย์ โชว์แค่จำนวน/ความเต็มต่อวัน (ผู้ใช้ขอ 2026-09-20
 * ให้กลับมาเป็นสัปดาห์จริงแทนที่รายการทั้งเดือน จะได้ดูล่วงหน้าทีละสัปดาห์เพื่อเตรียมตัว)
 * กดวันไหนเพื่อดูรายละเอียดแบบเดิม (4 ช่วงเวลา) ที่มุมมองวัน
 */
