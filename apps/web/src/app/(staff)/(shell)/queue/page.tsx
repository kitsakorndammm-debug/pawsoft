  ...
  return (
    <div className="flex h-full flex-col gap-3">
      <div className="flex flex-wrap items-center gap-2">
        ...
        {/*
          **จอแคบ: แถวนี้ขึ้นบรรทัดใหม่เต็มความกว้าง แล้วห่อตัวเองได้อีกชั้น** (แก้
          2026-09-15) — `ml-auto` เฉย ๆ เคยดันกลุ่มนี้ไปชิดขวาจนปุ่ม "ลงทะเบียนหน้างาน"
          โผล่พ้นขอบจอมือถือไปเลย ไม่มีทางเลื่อนไปกดได้
        */}
